...
import { 
  ...
  Activity, Users, ShoppingCart, Star, Eye, Settings, RefreshCw, Sparkles, Shield, AlertTriangle
} from 'lucide-react';
import AdminLayout from '../components/admin/AdminLayout';
import Shops from '../components/admin/Shops';
import EnhancedItemManager from '../components/admin/EnhancedItemManager';
...
type TabType = 'overview' | 'shops' | 'items' | 'categories' | 'trending' | 'analytics' | 'diagnostics';

          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                className={`w-full flex items-center justify-center space-x-3 bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 py-4 px-4 rounded-2xl transition-all font-medium shadow-sm ${
              ...
              <motion.button
                ...
                whileHover={{ scale: agreeToTerms && !loading ? 1.02 : 1 }}
                whileTap={{ scale: agreeToTerms && !loading ? 0.98 : 1 }}
                className={`w-full flex items-center justify-center space-x-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white py-4 px-4 rounded-2xl hover:from-gray-700 hover:to-gray-800 transition-all font-medium shadow-sm ${
                  loading || !agreeToTerms 
                    ? 'opacity-50 cursor-not-allowed' 
                    : 'hover:shadow-md'
                }`}

...
import MobileLanguageSwitch from '../components/MobileLanguageSwitch';
...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      {/* Enhanced Mobile Language Selector Modal */}
      {showLanguageModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          >
            ...
            <button
              ...
              className="w-full mt-4 bg-white/90 backdrop-blur-md text-gray-700 py-3 px-4 rounded-t-none sm:rounded-2xl font-medium shadow-lg"
            >
              Close
            </button>
          </motion.div>

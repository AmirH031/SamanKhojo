...
import { ArrowLeft, MapPin, Users, Zap, Heart, Target, Award, Smartphone, Globe, ShieldCheck, MessageCircle } from 'lucide-react';
...
const AboutPage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Chat with us on WhatsApp after you opt in. Reply STOP anytime to opt out. We use approved message templates and follow WhatsApp Business policies.',
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto">
              SamanKhojo was born from the idea that finding local shops should be simple and respectful of your privacy. We combine AI with WhatsApp to create an opt‑in bridge between customers and local entrepreneurs. You control your messaging preferences at all times.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white shadow-2xl">
            ...
            <p className="text-blue-100 mb-6">
              Join thousands who trust SamanKhojo. Opt in to WhatsApp updates or chat anytime—reply STOP to opt out.
            </p>
